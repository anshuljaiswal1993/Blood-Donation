			...
			<div style = "backgroud:white; font-size:2em">
				<form method = "get" action = "step2.php">
					<table style = "border: 1px solid black;" align = "center">
						<th colspan = "2">
							 Have you uploaded varification document
						</th>
						<tr>
							<td>
								<input type = "radio" name = "nit" value = "YES" checked> YES
							
							</td>
							<td>
								<input type = "radio" name = "nit" value = "NO"> NO
...
<?php
	if(isset($_GET['submit']))
	{
		...
		if($val == "NO")
		{
			echo "<script> alert('Please upload your varification document') </script>";
			echo "<script>window.location = 'upload_doc.php'</script>";
		}
		else
			echo "<script>window.location = 'final_step.php'</script>";
	}
?>
