    ...
    <div id="main-wrapper">
          ...
          <div class="image-section">
			...
			<div style = "backgroud:white; font-size:2em">
				<form method = "get" action = "upload_doc.php">
					<table style = "border: 1px solid black;" align = "center">
						<th colspan = "2">
							Please select varification document
						</th>
						<tr>
							<td>
								<input type = "file" name = "vdoc">
							</td>
						</tr>
						<tr>
								<td colspan = "2">
...
<?php
	...
	{
		if (is_uploaded_file($_FILES['vdoc']['tmp_name'])) 
		{

			if ($_FILES['vdoc']['type'] != "application/pdf") 
